<%@ Page Language="C#" AutoEventWireup="true" CodeFile="generosMusicales.aspx.cs" Inherits="Vista_UsuarioConsulta_generosMusicales" %>
        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td class="auto-style4">
                    <asp:GridView ID="gridGeneros" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowDeleting="gridGeneros_RowDeleting" Width="341px">
            ...
            <tr>
                <td class="auto-style2">&nbsp;</td>
                <td class="auto-style4">
                    <asp:GridView ID="gridArtistas" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowDeleting="gridArtistas_RowDeleting" Width="339px">
                        <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                        <Columns>
                            <asp:ButtonField ButtonType="Button" CommandName="Delete" Text="Ver" />
                        </Columns>
                ...
                <td class="auto-style5">
                    <asp:GridView ID="gridAlbumes" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Height="16px" OnRowDeleting="gridAlbumes_RowDeleting" Width="455px">
                        <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                        <Columns>
                            <asp:ButtonField ButtonType="Button" CommandName="Delete" Text="Abrir" />
                        </Columns>
                        <EditRowStyle BackColor="#999999" />
                        <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
                        <HeaderStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
            ...
            <tr>
                ...
                <td class="auto-style4">&nbsp;</td>
                <td class="auto-style5">
                    <asp:GridView ID="gridCanciones" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowDeleting="gridCanciones_RowDeleting" Width="391px">
                        <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                        <Columns>
