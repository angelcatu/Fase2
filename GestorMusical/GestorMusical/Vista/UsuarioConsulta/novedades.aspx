<%@ Page Language="C#" AutoEventWireup="true" CodeFile="novedades.aspx.cs" Inherits="Vista_UsuarioConsulta_novedades" %>
    ...
    <header>
        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td class="auto-style2">Noticias:</td>
                <td class="auto-style4">&nbsp;</td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td class="auto-style2">
                    <asp:GridView ID="gridNoticias" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Horizontal" Width="189px">
                        <AlternatingRowStyle BackColor="#F7F7F7" />
                        <Columns>
                            <asp:ImageField DataImageUrlField="Portada" HeaderText="Portada">
                            </asp:ImageField>
                            <asp:BoundField DataField="Titulo" HeaderText="Titulo" SortExpression="Titulo" />
                            <asp:BoundField DataField="Noticia" HeaderText="Noticia" SortExpression="Noticia" />
                        </Columns>
